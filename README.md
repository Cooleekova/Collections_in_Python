## Коллекции данных в Python (последовательности, словари и множества)

Короткая статья [про типы данных](https://wombat.org.ua/AByteOfPython/data_structures.html) и отличная [статья на Хабре.](https://habr.com/ru/post/319164/)
